...
class UpdateInfoLowonganController extends Controller
{
    //
    public function __invoke(Service $info_lowongan, InfoLowonganRequest $request)
    {
